...
/**
 * Local dev implementation of AuthProvider (D-09): seeded users + argon2id hashes in
 * PostgreSQL, JWT sessions. The Cognito swap target implements the same interface.
 */
